...
nexttile
plot(n,Fx)
title('F_x Error', 'FontSize',12,'FontWeight','bold')
xlabel('steps')
ylabel('N')

nexttile
plot(n,Fy)
title('F_y Error', 'FontSize',12,'FontWeight','bold')
xlabel('steps')
ylabel('N')

nexttile
plot(n,Fz)
title('F_z Error', 'FontSize',12,'FontWeight','bold')
xlabel('steps')
ylabel('N')

nexttile
plot(n,Mx)
title('M_x Error', 'FontSize',12,'FontWeight','bold')
xlabel('steps')
ylabel('Nm')

nexttile
plot(n,My)
title('M_y Error', 'FontSize',12,'FontWeight','bold')
xlabel('steps')
ylabel('Nm')

nexttile
plot(n,Mz)
title('M_z Error', 'FontSize',12,'FontWeight','bold')
xlabel('steps')
ylabel('Nm')
...
fname = '../Report/New';
image_name = strcat(filename, "_fm_error");
